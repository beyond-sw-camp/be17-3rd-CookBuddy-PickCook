...
public class RecipeController {
    ...
    @Operation(
            summary = "레시피 목록 조회",
            description = "등록되어 있는 레시피를 반환합니다."
    )
    @GetMapping
    public BaseResponse<PageResponse<RecipeDto.RecipeListResponseDto>> getRecipeList(
        ...
        Page<RecipeDto.RecipeListResponseDto> recipes = recipeService.getRecipeListWithFilter(userIdx, keyword, page, size, sortType, difficulty, category, cookingMethod);
